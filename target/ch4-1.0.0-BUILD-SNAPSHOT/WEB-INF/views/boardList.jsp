    ...
    <div class="board-container">
        ...
        <table>
            ...
            <c:forEach var="boardDto" items="${boardList}">
                <tr>
                    ...
                    <td class="regdate">${boardDto.regDate}</td>
        ...
        <div>
            <c:choose>
                ...
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/board/list?page=${paging.page-1}">[이전]</a>
                </c:otherwise>
            </c:choose>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/board/list?page=${paging.page+1}">[다음]</a>
                </c:otherwise>
            </c:choose>
        </div>
</body>
